...
import {bindActionCreators} from 'redux'
 ...
 class Step2 extends Component {
  ...
  isValidated() {
    ...
    return new Promise((resolve, reject) => {
      setTimeout(() => {
        ...
        this.props.actions.saveChanges(true)
  ...
  render() {
    ...
    return (
      <div className="step step2 review">
        <div className="row">
          <form id="Form" className="form-horizontal">
            <div className="form-group">
              <label className="col-md-12 control-label">
                <h1>Step 2: Review your Details and 'Save'</h1>
              </label>
            </div>
            <div className="form-group">
...
Step2.propTypes = {
  emailEmergency: PropTypes.string
};
