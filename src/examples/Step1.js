  ...
  isValidated() {
    return new Promise((resolve, reject) => {
      this.props.validate((error) => {
        ...
        if (this.props.emailEmergency != this.getValidatorData().emailEmergency) { // only update store of something changed
          this.props.actions.updateEmailEmergency(
            this.getValidatorData().emailEmergency,
            false // use this to notify step4 that some changes took place and prompt the user to save again
                ...
                <form id="Form" className="form-horizontal">
                  <div className="form-group">
                    <label className="control-label col-md-12 ">
                        <h1>Step 1: Form Validation using "react-validation-mixin" Example</h1>
                    </label>
                  </div>
                  <div className="form-group col-md-12 content form-block-holder">
                    ...
                    <div className={notValidClasses.emailEmergencyCls}>
                        <input
                            ...
                            required
                            defaultValue={this.props.emailEmergency}
